...
def generate_section(prompt: str, section: str, rhythm_scheme: str = "AABB", context: str = "") -> str:
    ...
    Args:
        ...
        section (str): The type of section to generate (e.g., Verse, Chorus).
        context (str): Additional context or details to include in the generation.
        
    Returns:
        str: The generated song section.
    """

    section_prompt = f"""
        Your are a professional songwriter. Write only the **lyrics** for the section titled **{section}**.
        ...
        The lyrics should match the style and the mood of the song.
        Do **not** include any other section outside of the **{section}**.
        Do **not** repeat the section multiple times.
        Keep it poetic, emotional and matching the theme and easy to sing.
